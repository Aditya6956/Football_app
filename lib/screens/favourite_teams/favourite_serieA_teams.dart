...
class FavouriteSerieATeamsScreen extends StatefulWidget {
  static const routeName = 'favourite-serieA-teams-screen';
  @override
  _FavouriteSerieATeamsScreenState createState() =>
      _FavouriteSerieATeamsScreenState();
}

class _FavouriteSerieATeamsScreenState
    extends State<FavouriteSerieATeamsScreen> {
  @override
  Widget build(BuildContext context) {
    final isDark = Provider.of<DarkMode>(context);
    final id = ModalRoute.of(context).settings.arguments;
    final leagueData = Provider.of<LeagueListProvider>(context);
    final league = leagueData.favouriteSerieATeams;
    return Scaffold(
      appBar: AppBar(
        title: Text(
