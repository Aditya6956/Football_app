...
class FavouriteBligaTeamsScreen extends StatefulWidget {
  static const routeName = 'favourite-bliga-teams-screen';
  @override
  _FavouriteBligaTeamsScreenState createState() =>
      _FavouriteBligaTeamsScreenState();
}

class _FavouriteBligaTeamsScreenState extends State<FavouriteBligaTeamsScreen> {
  @override
  Widget build(BuildContext context) {
    final isDark = Provider.of<DarkMode>(context);
    final id = ModalRoute.of(context).settings.arguments;
    final leagueData = Provider.of<LeagueListProvider>(context);
    final league = leagueData.favouriteBligaTeams;
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Favourite BundesLiga Teams',
